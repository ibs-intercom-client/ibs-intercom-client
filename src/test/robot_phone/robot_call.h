...
#ifndef __DOORCTRL_ROBOT_CALL_H__
#define __DOORCTRL_ROBOT_CALL_H__
...
namespace doorctrl {
  ...
  class RobotCall : public pj::Call {
    public:
      explicit RobotCall(pj::Account& acc, int call_id = PJSUA_INVALID_ID);
      virtual ~RobotCall() = default;
      bool isValid() const;
